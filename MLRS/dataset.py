...
from mlrsdataloader import MLRSDataset
import pandas as pd
...
def load_data() -> Tuple[Dataset, Dataset]:
    root = '/kaggle/input/mlrs-datasets/MLRS'
    training_df = pd.read_csv('/kaggle/input/mlrs-datasets/MLRS/testing_data.csv', header=0)
    test_df = pd.read_csv('/kaggle/input/mlrs-datasets/MLRS/training_data.csv', header=0)
    ...
    #define dataset
    trainset = MLRSDataset(train_df=training_df, train_dir=root, is_train=True, transform=transforms_data)
    testset = MLRSDataset(train_df=test_df, train_dir=root, is_train=True, transform=transforms_data)
