...
def main() -> None:
    ...
    FedAvgStrategy = fl.server.strategy.FedAvg(
        fraction_fit=0.5, #the fraction of available clients to use for evaluation of the model at each round of Federated Learning
        min_fit_clients=0.5, #the minimum number of clients that should be selected for training at each round of Federated learning
...
if __name__ == "__main__":
    main()
#!python main.py --balanced=True --strategy=FedAvg --batch_size=32 --num_clients=20 --num_rounds=100
